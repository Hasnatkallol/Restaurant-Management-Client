...
const Footer = () => {
  return (
    <div className="bg-[#29291F]">
      ...
      <div className="md:flex text-center lg:text-start lg:justify-around pb-10">
        <div>
        ...
        <div className="mt-5 lg:mt-0">
          <p className="text-[#D2D0A9] font-bold">Privacy Policy</p>
          <p className="text-[#D2D0A9] font-bold">Accessibility Statement</p>
          <p className="text-[#D2D0A9] font-bold">Terms & Conditions</p>
          <p className="text-[#D2D0A9] font-bold">Refund Policy</p>
        </div>
      </div>
